package com.fireants.customactivitycrash.config;
...
public class FireAntsCrashConfig implements Serializable {
    ...
    public static class Builder {
        private FireAntsCrashConfig config;

        @NonNull
        public static Builder create() {
            Builder builder = new Builder();
            FireAntsCrashConfig currentConfig = CustomActivityOnCrash.getConfig();

            FireAntsCrashConfig config = new FireAntsCrashConfig();
        ...
        @NonNull
        public FireAntsCrashConfig get() {
            return config;
        }
