package com.fireants.customactivitycrash.activity;
...
import com.fireants.customactivitycrash.CustomActivityOnCrash;
import com.fireants.customactivitycrash.config.FireAntsCrashConfig;
import com.fireants.customactivityoncrash.R;


public final class FireAntsErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fireants_crash);
        ...
        final FireAntsCrashConfig config = CustomActivityOnCrash.getConfigFromIntent(getIntent());
        ...
        if (config.isShowRestartButton() && config.getRestartActivityClass() != null) {
            ...
            restartButton.setOnClickListener(v -> CustomActivityOnCrash.restartApplication(FireAntsErrorActivity.this, config));
        } else {
            restartButton.setOnClickListener(v -> CustomActivityOnCrash.closeApplication(FireAntsErrorActivity.this, config));
        }
        ...
        if (config.isShowErrorDetails()) {
            moreInfoButton.setOnClickListener(v -> {
                String fullErrorDetails = CustomActivityOnCrash.getAllErrorDetailsFromIntent(FireAntsErrorActivity.this, getIntent());
    ...
    private void copyErrorToClipboard() {
        String errorInformation = CustomActivityOnCrash.getAllErrorDetailsFromIntent(FireAntsErrorActivity.this, getIntent());
        ...
        if (clipboard != null) {
            ...
            Toast.makeText(FireAntsErrorActivity.this, R.string.error_details_copied, Toast.LENGTH_SHORT).show();
        }
    }
