...
object FireAntsTrackingHelper {
     ...
     */
    fun logEvent(eventName: String, params: Bundle?): FireAntsTrackingHelper {
     ...
     */
    fun addScreenTrack(screenName: String): FireAntsTrackingHelper {
     ...
     * Chỉ gắn cho tracking theo màn hình theo yêu cầu của PM, PO, BA
     */
    fun fromScreenToScreen(fromScreen: String, toScreen: String): FireAntsTrackingHelper {
        Log.d("FireAntsTrackingHelper", "fromScreenToScreen: $fromScreen to $toScreen")
